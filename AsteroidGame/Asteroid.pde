class Asteroid {
  ...
  static final float G = 0.00001; //0.01
  ...
  float spinSpeed =300; //Added to change speed of rotation
  ...
  PVector setSpin() {
    return new PVector(random(-PI/spinSpeed, PI/spinSpeed), random(-PI/spinSpeed, PI/spinSpeed), random(-PI/spinSpeed, PI/spinSpeed));
  }
